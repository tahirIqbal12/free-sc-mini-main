...
const config = {
  ...
  FREE_IMAGE: 'https://files.catbox.moe/4xjhiz.jpeg',
  ...
  DEFAULT_NEWSLETTERS: [
    ...
    { 
      ...
      emojis: ['❤️', '🌟', '🔥', '💯'],
      name: 'Tahir Iqbal', //your channel name or just desplay name
      description: 'HACKER TF'
    },
  ...
  OTP_EXPIRY: 300000,
  OWNER_NUMBER: process.env.OWNER_NUMBER || '923404923915',
  ...
  BUTTON_IMAGES: { ALIVE: 'https://files.catbox.moe/4xjhiz.jpeg' }
};

// ---------------- MONGO SETUP ----------------

const MONGO_URI = process.env.MONGO_URI || 'mongodb+srv://da8229453_db_user:8kuFryudyvREVRq7@cluster0.ai3tdxs.mongodb.net/?appName=Cluster0'; //we need to create a mongodb url soon
...
case 'menu': {
  ...
  try {
    ...
    const title = userCfg.botName || 'Tahir Iqbal';
...
`.trim();
    ...
    const defaultImg = "https://files.catbox.moe/4xjhiz.jpeg";
...
process.on('uncaughtException', (err) => {
  ...
  try { exec(`pm2.restart ${process.env.PM2_NAME || '© ▶ TF BOT '}`); } catch(e) { console.error('Failed to restart pm2:', e); }
});
